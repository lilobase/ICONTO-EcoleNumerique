...
class CKEditor
{
     ...
     */
    public function CKEditor($basePath = null)
    {
        if (!empty($basePath)) {
     ...
     */
    public function configSettings($config = array(), $events = array())
    {
        $_config = $this->config;
     ...
     * \private
     */
    public function returnGlobalEvents()
    {
