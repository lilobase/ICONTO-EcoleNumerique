...
this.aanFeatures=[];this.oLanguage={sProcessing:"En cours...",sLengthMenu:"Montrer _MENU_ éléments",sZeroRecords:"Aucun résultat trouvé",sInfo:"Elément _START_ jusqu'à _END_ sur un total de _TOTAL_ éléments",sInfoEmpty:"Aucun élément",sInfoFiltered:"(Recherche sur _MAX_ éléments)",sInfoPostFix:"",sSearch:"Recherche :",sUrl:"",oPaginate:{sFirst:"Premier",sPrevious:"Précédents",sNext:"Suivant",sLast:"Dernier"}};
