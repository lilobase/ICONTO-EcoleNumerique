...
function add_node (field, idFile, nomFile) {
  
  jQuery('.'+field).append('<li><input type="hidden" name="'+field+'[]" value="'+idFile+'" /><span>'+nomFile+'</span> <a href="#" class="delete-node">X</a></li>');
}