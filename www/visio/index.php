    ...
    <head>
        ...
        <script type="text/javascript">
			...
			function startCall()
			{
				...
				getFlexApp('Iconisio').callVisio(callerLogin, receiverLogin, isCaller, red5Server, secondsToWait, secondsToRetry, textColor, textOverColor, infoTextColor);
			}
...
<?php
			if ($_POST) {
				echo "<param name=\"flashVars\" value=\"caller=".$_POST["callerLogin"]."&receiver=".$_POST["receiverLogin"]."&isCaller=".$_POST["isCaller"]."&red5=".$_POST["red5"]."&secondsToWait=".$_POST["secondsToWait"]."&secondsToRetry=".$_POST["secondsToRetry"]."&textColor=".$_POST["textColor"]."&textOverColor=".$_POST["textOverColor"]."&infoTextColor=".$_POST["infoTextColor"]."\" />;\n";
			}
?>
                <!--[if !IE]>-->
