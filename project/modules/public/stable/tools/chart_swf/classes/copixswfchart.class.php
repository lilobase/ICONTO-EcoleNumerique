...
/**
 * charts.php v4.5
 * @copyright 2003-2006, maani.us
* @package		tools 
 * @subpackage	chart_swf
 */
 
/**
 * Classe de base pour générer des graphes utilisant ChartsSWF
 * Modifications de Patrice Ferlet
* @package		tools 
 * @subpackage	chart_swf
 */
class CopixSwfChart {
	...
	function CopixSwfChart($swf = false, $library = false) {
	...
	function getChart($php_source, $width = 400, $height = 250, $bg_color = "666666", $transparent = false) {
