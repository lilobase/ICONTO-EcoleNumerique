<div class="column1 ink_blue">
	<div class="welcome_pages ink_blue">{copixzone process=welcome|pages titre='' blog=granville nb=2 colonnes=1 content=true}</div>
	<div class="welcome_articles">
		<div class="articles_title">{i18n key="welcome|welcome.articles"}</div>
		<div>{copixzone process=welcome|actualites blog=granville colonnes=1 chapo=1}</div>
	</div>
</div>
<div class="column2 ink_blue">
	<div class="welcome_photos">{copixzone process=welcome|photos mode=dewslider titre='' album=7 dossier=1 width=380 height=220 legendes=true}</div>
