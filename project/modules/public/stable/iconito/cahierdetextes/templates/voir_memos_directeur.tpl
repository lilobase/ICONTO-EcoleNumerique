      ...
      <div class="memo">
        <p class="memoDate">
          ...
          <span class="actions">
            ...
            <a href="{copixurl dest="cahierdetextes||supprimerMemo" ecoleId=$ppo->ecoleId cahierId=$memo->kernel_bu_ecole_classe_id memoId=$memo->id}" onclick="return confirm('{i18n key="cahierdetextes.message.deleteMemoConfirm"}')" title="{i18n key="cahierdetextes.message.delete"}"><img src="{copixurl}themes/default/images/button-action/action_delete.png" alt="{i18n key="cahierdetextes.message.delete"}" /></a>
          </span>
