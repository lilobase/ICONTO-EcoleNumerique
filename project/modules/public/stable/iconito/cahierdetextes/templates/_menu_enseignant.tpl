<div id="submenu">
  <div class="menuitems">
    <ul>
      ...
      <li><a class="chart{if $ppo->current == "voirTravauxParDomaine"} current{/if}" href="{copixurl dest="cahierdetextes||voirTravauxParDomaine" cahierId=$ppo->cahierId jour=$ppo->jour mois=$ppo->mois annee=$ppo->annee}"><span class="valign"></span><span>{i18n key="cahierdetextes.message.domains"}</span></a></li>
