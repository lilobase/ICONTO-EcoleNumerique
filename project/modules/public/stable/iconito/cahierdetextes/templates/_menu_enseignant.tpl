...
<div class="menuitems">
    <ul>
      ...
      <li class="newGroupItems"><a href="{copixurl dest="cahierdetextes||gererDomaines" nid=$ppo->nid jour=$ppo->jour mois=$ppo->mois annee=$ppo->annee}"><span class="valign"></span><span>{i18n key="cahierdetextes.message.domainsList"}</span></a></li>
