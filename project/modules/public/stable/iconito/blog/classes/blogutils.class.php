...
*/
    public function getBlogAdminMenu($blog, $action=99)
    {
...
function BDToDateTime($date, $time, $format)
{
    ...
    */
    public function returnAllBlogFunctions()
    {
        $results = array();
     ...
     */
    public function getNodeBlog ($parent_type, $parent_id, $options=array())
    {
        $blog = NULL;
        $trouve = false;
     ...
     * @return object Objet
     */
    public function create_blog_object ($id_blog)
    {
