...
<form action="{copixurl dest="rssmix|default|createp"}" method="post" id="rm-form" enctype="multipart/form-data">
    
    <div class="field">
        <label for="rm-i-title">{i18n key="rssmix.label.streamTitle" noEscape=1}</label> : 
        <input type="text" name="rm-title" id="rm-i-title" size="50" />
    </div>    
    <div class="field">
