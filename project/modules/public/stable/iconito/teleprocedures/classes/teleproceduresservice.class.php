...
class TeleproceduresService {
	 ...
	 */
	function canMakeInTelep ($action, $droit, $params=array()) {
		$can = false;
		switch ($action) {
	 ...
	 * @return null
	 */
	function alertResponsables ($rIntervention, $arDroits) {
	 ...
	 * @return null
	 */
	function alertChangeResponsables ($rIntervention, $responsables) {
	 ...
	 */
	function checkIfBlogExists ($rTelep) {
