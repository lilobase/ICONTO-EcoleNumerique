...
<img width="11" height="9" src="img/annuaire/icon_tel.gif" alt="{i18n key="annuaire.telephone"}" title="{i18n key="annuaire.telephone"}" border="0" hspace="1" /> {$ecole.ALL->eco_tel}<br/>
{/if}
...
{/if}
{if $ecole.blog}<a title="{i18n key="annuaire.blog"}" href="{$ecole.blog}">{i18n key="annuaire.blog"}</a><a href="{$ecole.blog}" target="_blank"><img alt="{i18n key="public|public.openNewWindow"}" title="{i18n key="public|public.openNewWindow"}" border="0" width="12" height="12" src="img/public/open_window.png" hspace="4" /></a><br/>{/if}
<a title="{i18n key="annuaire.fiche"}" href="{copixurl dest="fichesecoles||fiche" id=$ecole.id}">{i18n key="annuaire.fiche"}</a><a href="{copixurl dest="fichesecoles||fiche" id=$ecole.id}" onClick="return ajaxFicheEcole({$ecole.id});"><img alt="{i18n key="public|public.openPopup"}" title="{i18n key="public|public.openPopup"}" border="0" width="12" height="12" src="img/public/open_popup.png" hspace="4" /></a><br/>
