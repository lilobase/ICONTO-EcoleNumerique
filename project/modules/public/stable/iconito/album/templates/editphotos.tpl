	...
	{foreach from=$pictures item=picture}
		<tr class="">
			...
			<td width="1">
				...
				<img src="static/album/{$picture->album_id}_{$picture->album_cle}/{$picture->photo_id}_{$picture->photo_cle}{$picture_thumbsize}.{$picture->photo_ext}" border="0" alt="{$picture->photo_nom|htmlentities}" title="{$picture->photo_nom|htmlentities}" width="{$album_thumbsize_width}" height="{$album_thumbsize_height}" align="left" id="thumb_{$picture->photo_id}"/>
				</a>
			</td>
			<td align="left">
