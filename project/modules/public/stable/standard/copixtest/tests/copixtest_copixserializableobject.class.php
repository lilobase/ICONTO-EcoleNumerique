 ...
 * @subpackage copixtest
 */
class CopixTest_CopixSerializableObject extends CopixTest
{
    ...
    {
        $element = new CopixSerializableObject ($dao = _ioDAO ('copixtestautodao'), 'copixtestautodao');
    ...
    {
        $element = new CopixSerializableObject ($dao = _ioDAO ('copixtestmain'));
        $element->findAll ();//appel d'une méthode pour vérifier le pont
        ...
        $element = new CopixSerializableObject ($dao = _ioDAO ('copixtestmain'), 'copixtest|copixtestmain');
        $element->findAll ();//appel d'une méthode pour vérifier le pont
    ...
    {
        $element = new CopixSerializableObject ($record = _record ('copixtestautodao'), 'copixtestautodao');
    ...
    {
        $element = new CopixSerializableObject ($record = _record ('copixtestmain'));
        ...
        //--- Même chose en spécifiant le qualificateur
        $element = new CopixSerializableObject ($record = _record ('copixtestmain'), 'copixtest|copixtestmain');
    ...
    {
        $element = new CopixSerializableObject ($object = _ioClass ('fooclass'), 'copixtest|fooclass');
