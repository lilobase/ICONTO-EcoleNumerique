...
//          || (   is_dir($p_filedescr_list[$j]['filename'])
  ...
  public function privAddFile($p_filedescr, &$p_header, &$p_options)
  {
    ...
    */
    ...
    $p_header['internal'] = 0;
    $p_header['offset'] = 0;
    $p_header['filename'] = PclGetFileName($p_filename);
...
//      eval('$v_result = '.$p_options[PCLZIP_CB_POST_EXTRACT].'(PCLZIP_CB_POST_EXTRACT, $v_local_header);');
  ...
  public function privReadFileHeader(&$p_header)
  {
    ...
    // ----- Get filename
    $p_header['filename'] = PclGetFileName(fread($this->zip_fd, $v_data['filename_len']));
  ...
  public function privReadCentralFileHeader(&$p_header)
  {
    ...
    if ($p_header['filename_len'] != 0)
      $p_header['filename'] = PclGetFileName(fread($this->zip_fd, $p_header['filename_len']));
    else
      $p_header['filename'] = '';
  ...
  // --------------------------------------------------------------------------------
    ...
    /**
     * Reformatage d'un nom de fichier suivant le systeme d'encodage local
     *
  ...
  function PclGetFileName ($filename)
  {
    ...
    if ($info['extension']) {
      ...
      $filename = iconv( $get_host_iconv_encode , $get_file_mb_encode.'//TRANSLIT//IGNORE' , $filename );
    }
    return $filename;
  }
