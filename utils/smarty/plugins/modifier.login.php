...
function smarty_modifier_login ($login)
{
	...
	return $login.' <A TITLE="'.htmlentities(CopixI18N::get ('minimail|minimail.writeHim')).'" HREF="'.CopixUrl::get ('minimail||getNewForm', array('login'=>$login)).'"><IMG SRC="img/minimail/new_minimail.gif" WIDTH="12" HEIGHT="9" BORDER="0" /></A>';
