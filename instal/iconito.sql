...
-- 
-- Host: localhost
-- Generation Time: Jul 25, 2007 at 05:36 PM
...
-- 
-- Table structure for table `copixconfig`
-- 
...
CREATE TABLE copixgroup (
  ...
  description_cgrp varchar(255) default '',
...
-- 
-- Table structure for table `copixmodule`
-- 
...
-- 
-- Table structure for table `copixtemplate_theme`
-- 

DROP TABLE IF EXISTS copixtemplate_theme;
...
-- 
-- Table structure for table `copixuser`
-- 
...
-- 
-- Table structure for table `kernel_bu_annee_scolaire`
-- 
...
-- 
-- Table structure for table `kernel_bu_civilite`
-- 
...
-- 
-- Table structure for table `kernel_bu_classe_niveau`
-- 
...
-- 
-- Table structure for table `kernel_bu_classe_type`
-- 
...
-- 
-- Table structure for table `kernel_bu_cycle`
-- 
...
-- 
-- Table structure for table `kernel_bu_ecole`
-- 
...
-- 
-- Table structure for table `kernel_bu_ecole_classe`
-- 
...
-- 
-- Table structure for table `kernel_bu_ecole_classe_niveau`
-- 
...
-- 
-- Table structure for table `kernel_bu_eleve`
-- 
...
CREATE TABLE kernel_bu_eleve (
  ...
  `ele_last_update` timestamp NOT NULL,
  PRIMARY KEY  (`idEleve`),
...
-- 
-- Table structure for table `kernel_bu_eleve_admission`
-- 
...
-- 
-- Table structure for table `kernel_bu_eleve_affectation`
-- 
...
-- 
-- Table structure for table `kernel_bu_eleve_classe_mvt`
-- 
...
-- 
-- Table structure for table `kernel_bu_eleve_etat`
-- 
...
-- 
-- Table structure for table `kernel_bu_eleve_inscription`
-- 
...
-- 
-- Table structure for table `kernel_bu_eleve_periscolaire`
-- 
...
-- 
-- Table structure for table `kernel_bu_eleve_vaccins`
-- 
...
-- 
-- Table structure for table `kernel_bu_geo_departements`
-- 
...
-- 
-- Table structure for table `kernel_bu_groupe_villes`
-- 
...
-- 
-- Table structure for table `kernel_bu_lien_parental`
-- 
...
-- 
-- Table structure for table `kernel_bu_nationalite`
-- 
...
-- 
-- Table structure for table `kernel_bu_organisme`
-- 
...
-- 
-- Table structure for table `kernel_bu_pays`
-- 
...
-- 
-- Table structure for table `kernel_bu_pcs`
-- 
...
-- 
-- Table structure for table `kernel_bu_personnel`
-- 
...
-- 
-- Table structure for table `kernel_bu_personnel_entite`
-- 
...
-- 
-- Table structure for table `kernel_bu_personnel_role`
-- 
...
-- 
-- Table structure for table `kernel_bu_radiation`
-- 
...
-- 
-- Table structure for table `kernel_bu_responsable`
-- 
...
-- 
-- Table structure for table `kernel_bu_responsables`
-- 
...
-- 
-- Table structure for table `kernel_bu_rue`
-- 
...
-- 
-- Table structure for table `kernel_bu_scolarite`
-- 
...
-- 
-- Table structure for table `kernel_bu_sexe`
-- 
...
-- 
-- Table structure for table `kernel_bu_situation_familiale`
-- 
...
-- 
-- Table structure for table `kernel_bu_utilisateurs_bu`
-- 
...
-- 
-- Table structure for table `kernel_bu_utilisateurs_bu_entite`
-- 
...
-- 
-- Table structure for table `kernel_bu_utilisateurs_bu_profils`
-- 
...
-- 
-- Table structure for table `kernel_bu_ville`
-- 
...
-- 
-- Table structure for table `kernel_conf_uservisibility`
-- 
...
-- 
-- Table structure for table `kernel_ext_user`
-- 
...
-- 
-- Table structure for table `kernel_link_bu2user`
-- 
...
-- 
-- Table structure for table `kernel_link_groupe2node`
-- 
...
-- 
-- Table structure for table `kernel_link_user2node`
-- 
...
-- 
-- Table structure for table `kernel_mod_available`
-- 
...
-- 
-- Table structure for table `kernel_mod_enabled`
-- 
...
-- 
-- Table structure for table `kernel_sso_challenges`
-- 
...
-- 
-- Table structure for table `kernel_sso_users`
-- 
...
-- 
-- Table structure for table `module_agenda_agenda`
-- 
...
-- 
-- Table structure for table `module_agenda_event`
-- 
...
-- 
-- Table structure for table `module_agenda_lecon`
-- 
...
-- 
-- Table structure for table `module_album_albums`
-- 
...
-- 
-- Table structure for table `module_album_dossiers`
-- 
...
-- 
-- Table structure for table `module_album_photos`
-- 
...
CREATE TABLE module_blog (
  ...
  url_blog varchar(100) NOT NULL default '',
...
-- 
-- Table structure for table `module_blog_article`
-- 
...
-- 
-- Table structure for table `module_blog_article_blogarticlecategory`
-- 
...
-- 
-- Table structure for table `module_blog_articlecategory`
-- 
...
-- 
-- Table structure for table `module_blog_articlecomment`
-- 
...
-- 
-- Table structure for table `module_blog_fluxrss`
-- 
...
-- 
-- Table structure for table `module_blog_functions`
-- 
...
-- 
-- Table structure for table `module_blog_link`
-- 
...
-- 
-- Table structure for table `module_blog_page`
-- 
...
-- 
-- Table structure for table `module_carnet_messages`
-- 
...
-- 
-- Table structure for table `module_carnet_topics`
-- 
...
-- 
-- Table structure for table `module_carnet_topics_to`
-- 
...
-- 
-- Table structure for table `module_carnet_tracking`
-- 
...
-- 
-- Table structure for table `module_forum_forums`
-- 
...
-- 
-- Table structure for table `module_forum_messages`
-- 
...
-- 
-- Table structure for table `module_forum_topics`
-- 
...
-- 
-- Table structure for table `module_forum_tracking`
-- 
...
-- 
-- Table structure for table `module_groupe_groupe`
-- 
...
-- 
-- Table structure for table `module_liste_listes`
-- 
...
-- 
-- Table structure for table `module_liste_messages`
-- 
...
-- 
-- Table structure for table `module_logs_logs`
-- 
...
-- 
-- Table structure for table `module_magicmail`
-- 
...
-- 
-- Table structure for table `module_malle_files`
-- 
...
-- 
-- Table structure for table `module_malle_folders`
-- 
...
-- 
-- Table structure for table `module_malle_malles`
-- 
...
-- 
-- Table structure for table `module_minimail_from`
-- 
...
-- 
-- Table structure for table `module_minimail_to`
-- 
...
-- 
-- Table structure for table `module_prefs_preferences`
-- 
...
-- 
-- Table structure for table `module_ressource_annuaires`
-- 
...
-- 
-- Table structure for table `module_ressource_contenus`
-- 
...
-- 
-- Table structure for table `module_ressource_domaines`
-- 
...
-- 
-- Table structure for table `module_ressource_fonctions`
-- 
...
-- 
-- Table structure for table `module_ressource_licences`
-- 
...
-- 
-- Table structure for table `module_ressource_niveaux`
-- 
...
-- 
-- Table structure for table `module_ressource_res2contenu`
-- 
...
-- 
-- Table structure for table `module_ressource_res2domaine`
-- 
...
-- 
-- Table structure for table `module_ressource_res2fonction`
-- 
...
-- 
-- Table structure for table `module_ressource_ressources`
-- 
...
-- 
-- Table structure for table `module_ressource_tags`
-- 
...
-- 
-- Table structure for table `module_stats_logs`
-- 
...
-- 
-- Table structure for table `module_teleprocedure_infosupp`
-- 
...
-- 
-- Table structure for table `module_teleprocedure_intervention`
-- 
...
-- 
-- Table structure for table `module_teleprocedure_statu`
-- 
...
-- 
-- Table structure for table `module_teleprocedure_type`
-- 
...
-- 
-- Table structure for table `module_welcome_homes`
-- 
...
-- 
-- Table structure for table `module_welcome_url`
-- 
