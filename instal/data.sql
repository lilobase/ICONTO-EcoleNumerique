...
(1, 'Edito', 'Groupe destin� � g�rer la page d''accueil', 0, 1, DATE_ADD(NOW(), INTERVAL -1 MINUTE));
...
(1, 1, 0, 'Photos d�filantes', '', DATE_ADD(NOW(), INTERVAL -1 MINUTE), 'eefc8f8c50', 0),
...
(1, 1, 2, 'Bo�te', NULL, DATE_ADD(NOW(), INTERVAL -1 MINUTE), 'png', '2c8c12e0c6', NULL),
...
(1, 1, 1, 'Actualit�s', 'actualites20100921103303');
